  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="overflow-hidden rounded-lg border bg-white">
        {/* Header */}
        <div className="grid grid-cols-5 border-b bg-gray-50 px-4 py-3">
          {["Name", "Roll No.", "Class", "Section", ""].map((col) => (
        ...
        {Array.from({ length: 6 }).map((_, i) => (
          <div
            key={i}
            className="grid grid-cols-5 items-center border-b px-4 py-3 last:border-0"
          >
